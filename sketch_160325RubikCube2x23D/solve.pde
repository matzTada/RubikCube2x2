...
int [] r2P = {
  0, 1, 14, 15, 4, 5, 2, 3, 8, 9, 6, 7, 12, 13, 10, 11, 16, 17, 18, 19, 22, 20, 23, 21
};
int [] r2N = {
  0, 1, 6, 7, 4, 5, 10, 11, 8, 9, 14, 15, 12, 13, 2, 3, 16, 17, 18, 19, 21, 23, 20, 22
};
int [] r2T = {
  0, 1, 10, 11, 4, 5, 14, 15, 8, 9, 2, 3, 12, 13, 6, 7, 16, 17, 18, 19, 23, 22, 21, 20
};
int [] r3P = {
  2, 0, 3, 1, 16, 5, 18, 7, 8, 9, 10, 11, 12, 22, 14, 20, 15, 17, 13, 19, 4, 21, 6, 23
};
int [] r3N = {
  1, 3, 0, 2, 20, 5, 22, 7, 8, 9, 10, 11, 12, 18, 14, 16, 4, 17, 6, 19, 15, 21, 13, 23
};
int [] r3T = {
  3, 2, 1, 0, 15, 5, 13, 7, 8, 9, 10, 11, 12, 6, 14, 4, 20, 17, 22, 19, 16, 21, 18, 23
};
int [] r4P = {
  0, 1, 2, 3, 4, 17, 6, 19, 9, 11, 8, 10, 23, 13, 21, 15, 16, 14, 18, 12, 20, 5, 22, 7
};
int [] r4N = {
  0, 1, 2, 3, 4, 21, 6, 23, 10, 8, 11, 9, 19, 13, 17, 15, 16, 5, 18, 7, 20, 14, 22, 12
};
int [] r4T = {
